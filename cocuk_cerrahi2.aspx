<%@ Page Title="Çocuk Cerrahisi" Language="C#" MasterPageFile="~/kullanicisablonu2.Master" AutoEventWireup="true" CodeBehind="cocuk_cerrahi2.aspx.cs" Inherits="webtasarimperformansi.cocuk_cerrahi2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <div class="menu2">
           ...
           <li><a href="index2.aspx">Ana Sayfa</a></li>
               ...
               <li><a href="onlinehizmet2.aspx">Online Hizmetlerimiz</a></li>
