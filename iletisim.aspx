<%@ Page Title="İletişim" Language="C#" MasterPageFile="~/kullanicisablonu.Master" AutoEventWireup="true" CodeBehind="iletisim.aspx.cs" Inherits="webtasarimperformansi.iletisim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <div class="menu2">
           ...
           <li><a href="index.aspx">Ana Sayfa</a></li>
               ...
               <li><span class="span"><a href="iletisim.aspx">Bize Ulaşın</a></span></li>
